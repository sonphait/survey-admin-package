...
var QuestionFileEditorImplementor = /** @class */ (function (_super) {
    ...
    function QuestionFileEditorImplementor(question) {
        ...
        _this.setCallbackFunc("dochange", function (data, event) {
            _this.question.doChange(getOriginalEvent(event));
        });
...
Object(survey_core__WEBPACK_IMPORTED_MODULE_58__["checkLibraryVersion"])("".concat("1.9.112"), "survey-creator-knockout");
